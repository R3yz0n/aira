...
import { AdminModel } from "../lib/models/admin.js";
import { mongoose } from "../lib/db/mongoose.js";
...
async function main() {
  ...
  if (!password) {
    console.error("Usage: node scripts/create-admin.mjs PASSWORD [SETUP_SECRET]");
    process.exit(1);
  }
